        ...
        if let Some(first_image) = images.first() {
            if let Some(url) = first_image["url"].as_str() {
                let extension = url
                    ...
                    .and_then(|ext| ext.to_str()).unwrap_or("jpeg");
...
// pub struct EarlyAccessConfig {
//     #[serde(rename = "timeframe")]
//     pub timeframe: u128,
//
//     #[serde(rename = "donationGoal")]
//     pub donation_goal: u64,
//
//     #[serde(rename = "downloadPrice")]
//     pub download_price: u64,
//
//     #[serde(rename = "donationGoalId")]
//     pub donation_goal_id: u64,
//
//     #[serde(rename = "generationPrice")]
//     pub generation_price: u64,
//
//     #[serde(rename = "chargeForDownload")]
//     pub charge_for_download: bool,
//
//     #[serde(rename = "originalTimeframe")]
//     pub original_timeframe: String,
//
//     #[serde(rename = "chargeForGeneration")]
//     pub charge_for_generation: bool,
//
//     #[serde(rename = "donationGoalEnabled")]
//     pub donation_goal_enabled: bool,
//
//     #[serde(rename = "originalPublishedAt")]
//     pub original_published_at: String,
//
//     #[serde(rename = "generationTrialLimit")]
//     pub generation_trial_limit: u64,
// }
//
// #[derive(Serialize, Deserialize)]
